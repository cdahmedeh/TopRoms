...
<details>
<summary><b>Sets and Systems included in TopRoms</b></summary>
...
- [Libretro and RetroArch](https://www.libretro.com) - I still remember the last 90s and early 2000s when emulators were all over the place, with feature sets and setup issues unique to each package. Libretro and the associated RetroArch became unifying platform for almost all available emulators. Open-source and runs on pretty much any platform you can imagine. Interface is a bit complicated due to the plethora of features and tweaks but pairs excellently with various front-ends.
